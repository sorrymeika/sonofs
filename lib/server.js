...
const MAX_FILE_SIZE = 1024 * 100 - 1;
...
function createServer(cfg) {
    ...
    const server = net.createServer((socket) => {
        ...
        socket.on('data', (buf) => {
            ...
            // console.log('server recive buf:', buf, buf.length);
            ...
            if (type == 0) {
                ...
                do {
                    ...
                    console.log('大文件保存:', rangeOffset, offset, rangeSize);
                    ...
                    filePromise
                        .then(({ fd, msg }) => {
                            ...
                            console.log('大文件保存: fileStart', fileStart, rangeOffset, offset, rangeSize);
